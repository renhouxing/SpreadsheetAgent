...
YAML_STRUCTURE = """You are a spreadsheet expert who can analyze and manipulate spreadsheets using Python. Your task is to detect tables in a spreadsheet and generate hierarchical structures for their top-row and left-column headers.  
...
(3) Output Format
For each table, please generate a hierarchical structure in the following YAML format (with your reasoning content and other summary infomation).
```yaml
